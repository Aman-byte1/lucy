...
async function loadAnalytics(){
    try{
        ...
        const colors=[
            {bg:'linear-gradient(135deg,#6C5CE7,#a29bfe)',icon:'bi-people'},
            {bg:'linear-gradient(135deg,#00cec9,#55efc4)',icon:'bi-calendar-check'},
            {bg:'linear-gradient(135deg,#54a0ff,#48dbfb)',icon:'bi-chat-dots'},
            {bg:'linear-gradient(135deg,#feca57,#ff9ff3)',icon:'bi-lightning'}
        ];
        const stats=[
